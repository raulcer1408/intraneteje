...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Escuela de Jueces">
  ...
  <body>
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            ...
            <input id="txtPassword" name="txtPassword" class="form-control" type="password" placeholder="Contraseña" autocomplete="off">
          </div>
          <div class="form-group">
            <div class="utility">
    ...
    <script src="<?= media(); ?>/js/bootstrap/js/bootstrap.min.js"></script>
    <script src="<?= media(); ?>/js/fontawesome.js"></script>
    <script src="<?= media(); ?>/js/main.js"></script>
    <!-- The javascript plugin to display page loading on top-->
    <script src="<?= media(); ?>/js/pace.min.js"></script>
    <script type="text/javascript" src="<?= media();?>/js/sweetalert2/sweetalert2.min.js"></script>
